...
public class URLConfigTest {
	...
	public void ClientUIURLConfigTest() throws MalformedURLException{
		...
		assertEquals(new URL("file:src/main/resources/ui/clientui/fxml/create_order.fxml"), ClientUIURLConfig.client_create_order_fxml_url());
		assertEquals(new URL("file:src/main/resources/ui/clientui/css/create_order.css"), ClientUIURLConfig.client_create_order_css_url());
