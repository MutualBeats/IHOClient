...
public class CreditDataServiceImpl_Stub implements CreditDataService {
	...
	public ArrayList<CreditPO> find(String clientID) throws RemoteException {
		...
		creditList.add(new CreditPO(clientID, "2016/10/16 11:30:24", CreditChangeAction.ExecuteOrder, clientID, 100, 300));
		creditList.add(new CreditPO(clientID, "2016/10/14 6:20:30", CreditChangeAction.RepealOrder, clientID, 100, 200));
		return creditList;
	}
