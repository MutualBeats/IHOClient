...
public class PromotionChooseController {
    ...
    static{
    	try {
			FIELD_FXML=new URL("file: src/main/resources/ui/marketui/fxml/web_promotion_memberdiscount.fxml");
			FIELD_CSS=new URL("file: src/main/resources/ui/marketui/css/web_promotion_memberdiscount.css");
	    	
			TIME_FXML=new URL("file: src/main/resources/ui/marketui/fxml/web_promotion_timediscount.fxml");
			TIME_CSS=new URL("file: src/main/resources/ui/marketui/css/web_promotion_timediscount.css");
